...
export const getReady = async (req, res, next) => {
  ...
  try {
    ...
    const data = {
      ...
      approval_url: `https://hemstitch-cubical-spry.ngrok-free.dev/kakao/approve?partner_order_id=${orderId}`, //카카오에서 redirection url
      fail_url: "http://192.168.20.137:3000/fail",
      cancel_url: "http://192.168.20.137:3000/cancel",
    };

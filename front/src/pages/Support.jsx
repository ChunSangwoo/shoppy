...
export default function Support() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const numbered = listRes.map((item, idx) => ({
        ...item,
        rowNumber: listRes.length - idx,
      }));
      setAllList(numbered);
    };
    fetchData();
  ...
  useEffect(() => {
    ...
    if (stype !== "all")
      filtered = filtered.filter((item) => item.type === stype);
    ...
    <div className="content">
      <div className="support center-layout">
        ...
        <div className="support-content">
          <p style={{ color: "#777" }}>
            CGV의 주요한 이슈 및 여러가지 소식들을 확인할 수 있습니다.
          </p>
